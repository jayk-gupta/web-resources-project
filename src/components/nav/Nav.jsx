...
const Nav = () => {
  ...
  return (
    ...
    <div className="nav-container">
      ...
      <div className={`hamburger ${isSidebarOpen ? "open" : ""} items-center`} onClick={toggleSidebar}>
      ...
      {isSidebarOpen && (
        <div className="sidebar">
          <div className="sidebar-options fixed h-screen bg-[#76118f] py-2 px-4 text-xl w-[5%] gap-20 items-center">
            ...
            <NavLink to="/">
              <div className="group flex flex-col gap-3 justify-center items-center" style={{ marginTop: '50px' }}>
                <img
                  className="s"
            ...
            <NavLink to="/">
              <div className="group flex flex-col gap-3 justify-center items-center" style={{ marginTop: '40px' }}>
